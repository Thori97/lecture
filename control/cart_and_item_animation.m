function [sys,x0,str,ts,simStateCompliance] = cart_and_item_animation(t,x,u,flag,RefBlock)
...
set(ud.Pend,...
  'XData',ones(2,1)*[u(3)-PDelta u(3)+PDelta]), ...
set(ud.TimeField,...
  'String',num2str(time));
set(ud.RefMark,...
...
if ishghandle(Fig ,'figure'),
  ...
  set(FigUD.Pend,...
      'XData',ones(2,1)*[XPend-PDelta XPend+PDelta]);
